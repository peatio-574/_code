...
:: 启动5个爬虫进程（无多余引号）
start "Spider-1" cmd /c d:\_code\python3.13.11\python.exe d:/_code/spider_telephone/spider_1.py
start "Spider-2" cmd /c d:\_code\python3.13.11\python.exe d:/_code/spider_telephone/spider_2.py
